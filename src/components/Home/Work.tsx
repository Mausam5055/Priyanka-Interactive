...
const Work = ({
  ...
  const elems = [
    {
      heading: "Wanderlust Diaries",
      subHeading: "Capturing Moments Across the Globe",
      video: workvid1,
      image: workimg1,
    },
    {
      heading: "Golden Hour Glimpses",
      subHeading: "Where Light Meets Life",
      video: workvid2,
      image: workimg2,
    },
    {
      heading: "Everyday Chronicles",
      subHeading: "Ordinary Days, Extraordinary Stories",
      video: workvid3,
      image: workimg3,
    },
    {
      heading: "Frames of Joy",
      subHeading: "Smiles, Memories, and Magic",
      video: workvid4,
      image: workimg4,
    }
  ...
  return (
    ...
    >
      ...
      A collection of cherished moments and snapshots, captured with heart and creativity over the years with loved ones and kindred spirits.
      </p>
