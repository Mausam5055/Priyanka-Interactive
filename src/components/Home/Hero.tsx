      ...
      <div className="absolute w-full top-0 left-0">
        <div className="heroTextContainer text text-white  mx-auto h-full px-5 sm:px-32">
          <div className="para mt-[32rem]">
            {[
              " I am Priyanka Narth Mazumdar,",
              " a passionate biotechnology student working towards innovative solutions,",
              " that improve the way people live, work, and thrive."
            ].map((item) => (
              <p
          ...
          <div className="headings mt-5 sm:mt-44">
            {["Priyanka", "Nath", "Mazumdar"].map((item) => (
              <h1
          ...
          <div className="mt-20 sm:mt-32">
            ...
            I help research-driven initiatives thrive by highlighting the intricate potential of biotechnology in improving lives and shaping the future. Groundbreaking discoveries begin with a single step.
            </p>
            <div className="flex justify-between items-center mt-5 sm:mt-20">
              ...
              <div className="flex gap-32 max-sm:hidden">
                ...
                <div className="space-y-3">
                  {["pnmaz@gmail.com", "+91 93956 04326"].map((item) => {
                    return (
                      <a
                        key={item}
